/**
 * WelcomeEmail - Customer welcome email template
 *
 * Sent when a new customer account is created.
 * Includes login credentials and getting-started steps.
 *
 * @param {Object} props
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .header { background: linear-gradient(135deg, #D76A84 0%, #EC4899 100%); color: white; padding: 30px; text-align: center; border-radius: 12px 12px 0 0; }
        ...
        .credentials { background: #f9fafb; border-left: 4px solid #D76A84; padding: 20px; margin: 20px 0; border-radius: 8px; }
        .credentials h3 { margin-top: 0; color: #D76A84; }
        ...
        .button { display: inline-block; background: #D76A84; color: white; padding: 12px 30px; text-decoration: none; border-radius: 8px; margin: 20px 0; font-weight: 600; }
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>Your customer portal is ready</p>
        </div>
        <div class="content">
          <h2 style="color: #111827; margin-top: 0;">Hello ${customerName},</h2>
          <p>Your <strong>Customer</strong> account has been created. You now have access to view your inspection projects, download reports, and track progress in real time.</p>
          ...
          <ol class="steps">
            ...
            <li>Explore your dashboard to see project statuses</li>
            <li>Download reports once inspections are complete</li>
          </ol>
