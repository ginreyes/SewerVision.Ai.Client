/**
 * WelcomeEmail - Operator welcome email template
 *
 * Sent when a new Operator account is created.
 ...
 * @param {string} props.email - Operator email
...
export const WelcomeEmail = ({
    ...
    <head>
      ...
      <style>
        ...
        .credentials { background: #fffbeb; border-left: 4px solid #F59E0B; padding: 20px; margin: 20px 0; border-radius: 8px; }
        .credentials h3 { margin-top: 0; color: #D97706; }
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>Your Operator portal is ready</p>
        </div>
        <div class="content">
          <h2 style="color: #111827; margin-top: 0;">Hello ${operatorName},</h2>
          <p>Your <strong>Operator</strong> account has been created. You can now manage field inspections, operate CCTV equipment, record footage, and track your assigned projects.</p>
          ...
          <ol class="steps">
            ...
            <li>Check your assigned projects on the dashboard</li>
            <li>Connect your CCTV devices from the Equipment page</li>
            <li>Start field inspections and record footage</li>
          </ol>
