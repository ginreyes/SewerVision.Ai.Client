...
const ROLE_THEMES = {
  ...
  'qc-technician': {
    gradient: 'from-[#D76A84] via-rose-500 to-pink-600',
    activeBg: 'from-rose-50 to-pink-50',
    activeText: 'text-rose-700',
    activeIcon: 'text-rose-600',
    activeBar: 'from-[#D76A84] to-rose-500',
    hoverOverlay: 'group-hover:from-rose-500/5 group-hover:to-pink-500/5',
    loaderColor: 'text-rose-500',
    chevronColor: 'text-rose-500',
    footerBg: 'from-green-50 to-emerald-50',
    footerBorder: 'border-green-200/50',
                          ...
                          {isItemLoading ? (
                            ...
                            <Icon
                              ...
                              className={cn(
                                ...
                                itemActive ? theme.activeIcon : 'text-gray-500 group-hover:text-gray-700'
                              )}
                            />
                          )}
                        </div>
                        ...
                        {isOpen && (
                          <>
                            <span className={cn(
                              ...
                              itemActive ? theme.activeText : 'text-gray-700 group-hover:text-gray-900'
                            )}>
                              {item.label}
                            </span>
                            {itemActive && (
